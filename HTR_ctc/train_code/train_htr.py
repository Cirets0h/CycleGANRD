...
if __name__ == "__main__":
    ...
    path_to_models = '/home/manuel/CycleGANRD/PyTorch-CycleGAN/output/'
    ...
    if save_number == 0:
        ...
        for generator_path in dir_list:
            ...
            run_name = 'new_' + str(save_number) + '_ep' + os.path.basename(os.path.normpath(generator_path) + '_aug' + str(augment_factor))
            #
            api = wandb.Api()
